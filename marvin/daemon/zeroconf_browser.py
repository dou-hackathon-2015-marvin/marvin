...
def find_all_marvins(ip_v6=False):
    '''
    ...
    '''
    try:
        avahi_finder = _AvahiMarvinFinder(ip_v6)
        avahi_finder.run()
        return avahi_finder.services_found
    except NameError:
        return []
    
class _AvahiMarvinFinder(object):
    '''
        ...
        sbrowser = dbus.Interface(
                       bus.get_object(
                           ...
                           self.server.ServiceBrowserNew(
                               ...
                               '_marvin._tcp', 'local', dbus.UInt32(0)
                            )
